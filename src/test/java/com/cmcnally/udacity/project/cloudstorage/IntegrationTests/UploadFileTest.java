...
public class UploadFileTest {
    ...
    private String testFirstName = "Karl";
    private String testLastName = "Johnson";
    private String testUsername = "kjohnson";
    private String testPassword = "KarlsPassw0rd";
    ...
    public void testUploadFile() throws InterruptedException {
        /*
            Preconditions:
            The user must be signed up and logged in before they can upload a file.
